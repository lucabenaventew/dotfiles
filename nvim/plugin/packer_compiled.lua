...
_G.packer_plugins = {
  ...
  ["auto-save.nvim"] = {
    loaded = true,
    path = "/home/luca/.local/share/nvim/site/pack/packer/start/auto-save.nvim",
  ...
  ["telescope-file-browser.nvim"] = {
    loaded = true,
    path = "/home/luca/.local/share/nvim/site/pack/packer/start/telescope-file-browser.nvim",
